 ...
 *
 * About this configuration by gergap:
 * -----------------------------------
 * - Changes by gergap for ..
 * - Mendel90 Dibond
 * - Using Ramps 1.4 electronics and NEMA 17 motors (1.7A)
 * - Polulo Stepper Motor drivers A4988
 * - Print Bed MK2
 * - Wade Extruder
 * - Thermistors: Honeywell NTC 100K (5%) - 135-104-LAF-J01
 * - Mechanical endstops connected directly (pullup required)
 * The parts are from https://www.electronic-things.de
 *
 * Wiring:
 * -------
 * Power Outputs:
 *   D8: Print Bed Heating
 *   D9: Fan (extruder)
 *   D10: Extruder Heating
 * Motor Outputs:
 *   X: 1 NEMA17
 *   Y: 1 NEMA17
 *   Z: 2 NEMA17 in parallel
 *   E: 1 NEMA17
 * Endstops:
 *   D3: X endstop
 *   D14: Y endstop
 *   D18: Z endstop
 * Thermistors:
 *   T0: Extruder thermistor
 *   T1: Heatbed thermistor
 */
...
#define STRING_CONFIG_H_AUTHOR "gergap" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // gergap's Mendel90 autotune parameter
  #define  DEFAULT_Kp 83.52
  #define  DEFAULT_Ki 10.76
  #define  DEFAULT_Kd 162.16
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  //    O-- FRONT --+
  //  (0,0)
  #define X_PROBE_OFFSET_FROM_EXTRUDER -56  // X offset: -left  [of the nozzle] +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -10  // Y offset: -front [of the nozzle] +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -1.9   // Z offset: -below [the nozzle] (always negative!)
...
#define DEFAULT_MAX_FEEDRATE          {300, 300, 250.0/60.0, 25}    // (mm/sec)
